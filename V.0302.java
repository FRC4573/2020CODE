...
public class Robot extends TimedRobot {
  ...
  static final int BTNBELTREVERSE = 5;
  static final int BTNINTAKE = 2; //use trigger for intake
  static final int BTNSHOOTERHIGH = 3; //button 3 for shooter
  static final int BTNSHOOTERLOW = 4; //button 2 for shooter
  static final int NONE = -1;
  static final int BTNBELT = 1; //button for Belt
  static final int BTNCRAWLRIGHT = 9;
  static final int BTNCRAWLLEFT = 8;
  static final int BTNINTAKEBACK = 10;
  ...
  static final int BTNCLIMBUP = 6;
  static final int BTNCLIMBDOWN = 7;
 ...
 //liftPiston = new DoubleSolenoid(0, 1); // Cylinder solenoid ch. 0/1 for Lift Piston
  ...
  public void autonomousPeriodic() {
    ...
    while(timer.get()<4){
      ...
      m_LOutakeMotor.set(1.00);
      m_ROutakeMotor.set(-1.00);
